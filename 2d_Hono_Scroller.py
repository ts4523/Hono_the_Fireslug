...
mountain_img = pygame.transform.scale(pygame.image.load(
    "Assets/Images/bg_mountains_pix.png").convert_alpha(),
                                      (1200, 500))
pine1_img = pygame.transform.scale(pygame.image.load("Assets/Images/bg_pine3.png").convert_alpha(), (1200, 370))
# world tiles
img_list = []
...
def draw_bg():
    ...
    for x in range(4):
        screen.blit(mountain_img, ((x * width) - bg_scroll * .5, 0))
        screen.blit(pine1_img, ((x * width) - bg_scroll, 500 - pine1_img.get_height()))
...
while run:
    ...
    if game_mode == "play":
        ...
        if player.alive:
            ...
            screen_scroll, level_complete = player.move(move_l, move_r)
